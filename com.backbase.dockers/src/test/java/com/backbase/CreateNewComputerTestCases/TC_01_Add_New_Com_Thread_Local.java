...
import com.backbase.appPages.Page_Home_ThreadLocal;
...
public class TC_01_Add_New_Com_Thread_Local extends BaseSetUp_Dockers {
	...
	static int i=0;
	Page_Home homePgObj;
	Page_Home_ThreadLocal homePgObj_td;
	...
	public void TC_01_Verify_New_Computer_Addition_With_Valid_Data_Thread_Local(Map <String,String> data) throws ParseException
	{
		
		homePgObj_td= new Page_Home_ThreadLocal(driver_td);
		//homePgObj_td= new Page_Home_ThreadLocal();
